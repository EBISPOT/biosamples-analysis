...
if __name__ == "__main__":
    ...
    parser.add_argument('--correct-obsolete', action='store_true')
    parser.add_argument('--correct-organism', action='store_true')
    ...
    if args.correct_obsolete:
        correct_obsolete_terms(driver)
    if args.correct_organism:
